...
$memberName = queryShowData("SELECT name FROM member_register WHERE email = '$getEmail'");

$dataTransaction = queryShowData("SELECT * FROM member_transaction WHERE author = '$getEmail'");
